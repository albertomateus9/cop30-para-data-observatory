...
PROJECT = {
  "code": "P20",
  "slug": "cop30-para-data-observatory",
  "title": "COP30 Para Data Observatory",
  "discipline": "Semester Integrator Project",
  "disciplinePt": "Projeto Integrador do Semestre",
  "difficulty": "Advanced for semester",
  "difficultyPt": "Avancado para o semestre",
  "kind": "observatory",
  "dataset": "Integrated public-data sample for Para and climate context",
  "source": "INPE, IBGE, SEMA-PA, INMET, OpenAQ public sources",
  "description": "Integrator project combining public-data samples, SQLite, notebooks, and charts about Para in the COP30 context.",
  "concepts": [
    "SQLite",
    "multi-source data",
    "EDA",
