...
PROJECT = {
  ...
  "title": "Observatorio De Dados COP30: Para Em Numeros",
  "discipline": "Projeto Integrador Do Semestre",
  "disciplinePt": "Projeto Integrador Do Semestre",
  "kind": "observatory",
  "dataset": "Amostra segura local",
  "source": "Amostra sintetica local",
  "description": "Projeto integrador com SQLite, notebooks e graficos sobre dados publicos no contexto COP30.",
  "topics": [
    "data-science",
    "python",
    "jupyter-notebook",
